...
df = pd.read_csv('/home/autonomous/car_ws/src/autonomous_v/src/tracking/ref1_20_round_2.csv')
...
plt.plot(raw_y_north,raw_x_east,color='red',marker = '.',label='Raw')
plt.plot(y_north,x_east,color='blue',marker = '.',label='Moving Average')
