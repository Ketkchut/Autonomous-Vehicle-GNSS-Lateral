...
def cte_positive_negative(y_east,error_cte):
    ...
    ##linear equation is -0.008607, -1, 674482.034966 (88.856291 m)

    global error_positive_negative,cte_previous
    cte_previous = error_positive_negative
    if y_east >= 661480.2636 and y_east <= 661489.5472 :      #cte range 0.77m -1.226195m  ##Max,Min Left   661480.2636,661489.5472
        error_positive_negative = error_cte
    elif y_east<= 661491.436 and y_east >= 661489.6863 :    #cte 0.85m - -1.283984 m     ##,Max,min Right  661491.436,661489.6863
