...
df = pd.read_csv('/home/pond/ros_ws/src/autonomous_pkg/src/tracking/CSV_linear_StoN/ref1_Min_right_1.csv')
...
plt.plot(raw_x_east,raw_y_north,color='red',marker = '.',label='Raw')
plt.plot(x_east,y_north,color='blue',marker = '.',label='Moving Average')

# for index in range(len(x_east)):
#     x_east.text(x_east[index], y_north[index], size=12)
