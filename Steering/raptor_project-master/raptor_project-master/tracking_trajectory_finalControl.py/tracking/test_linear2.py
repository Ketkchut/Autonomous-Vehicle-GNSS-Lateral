...
def cte_current(x_car,y_car,A,B,c):
    cross_track_error = abs((A*y_car)+(B*x_car)+c)/math.sqrt(A**2+B**2)
...
if __name__ == '__main__':
    ...
    #=== import file path reference to compute====================
            a,b,c =  0.006923016, -1 ,1505006.8807523265                     #receive param linear eqaution of path ref
    # #cal CTE
