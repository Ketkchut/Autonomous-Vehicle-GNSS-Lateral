...
#====== Port conection =============
port1 = "COM43"                                 #port usb that connect rover in your computer for gnss f9p
...
if __name__ == '__main__':
    ...
    # #cal CTE
            a,b,c =  a3,b3,c3 =  -0.9479336077, -1 ,2092481.2061952758 
           
            error_current = cte_current(x_north,offset_y_east,a,b,c)
            cte_pos_neg = cte_positive_negative(offset_y_east,error_current)
           #(1509600.9766701984, 661487.2553659799)  จีพีเอสทับเส้นเลย เริ่มต้นทางโค้งแรก
    ...
    #         yaw_controlSteering = angle_controlMotor(cte_pos_neg,yaw_expect,yaw_prev)
            ...
            test_see = utm_position
            with open('ref_curve1.csv', 'a', newline='') as f:  
                writer = csv.writer(f,delimiter=",")    
                writer.writerow(test_see) 

            test_see2 = gps
            with open('curve1_latlng.csv', 'a', newline='') as f:  
                writer = csv.writer(f,delimiter=",")    
