...
x2 = [] 
y2 =[]
ref_latlng ='ref_linear2_latlng.csv' #gps= lat,lng
ref_utm ='ref_linear2_UTM.csv'       #utm = xnorth,yeast
...
plt.xlabel('Time (second)')
# naming the y axis
axs[0].set( ylabel='CTE_right (Meter)')
plt.ylabel('Yaw_right (Degree)')
...
fig.suptitle('Tracking Trajectory Line2 From right ')
