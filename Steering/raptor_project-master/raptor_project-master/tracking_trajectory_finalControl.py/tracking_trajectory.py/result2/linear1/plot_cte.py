...
#===========================Result ================================================================
FileData1 = 'ref_linear1_UTM.csv'
with open (FileData1) as f:
    data_result0 = pd.read_table(f, sep=',', header=0, names=['x','y'], lineterminator='\n')
    
xNorth = data_result0.x
yeast = data_result0.y
FileData1 = 'center_CteYaw.csv'
with open (FileData1) as f:
