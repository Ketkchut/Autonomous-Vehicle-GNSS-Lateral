...
# First/Curve2/Set1/C4_S1_MAXLEFT_1.csv
...
s8_minleft15_east = ( mean(df_mnl_1['x_east']) + mean(df_mnl_2['x_east']) ) /2
s8_minleft15_north = ( mean(df_mnl_1['y_north']) + mean(df_mnl_2['y_north']) ) /2
s8_ref_east = ( mean(df_ref_1['x_east']) + mean(df_ref_2['x_east']) ) /2
s8_ref_north = ( mean(df_ref_1['y_north']) + mean(df_ref_2['y_north']) ) /2
s8_minright15_east = ( mean(df_mnr_1['x_east']) + mean(df_mnr_2['x_east']) ) /2
s8_minright15_north = ( mean(df_mnr_1['y_north']) + mean(df_mnr_2['y_north']) ) /2
...
plt.scatter(s8_maxleft_east     ,s8_maxleft_north       ,color='red')
# plt.scatter(s8_minleft15_east   ,s8_minleft15_north     ,color='blue')
plt.scatter(s8_ref_east         ,s8_ref_north           ,color='black')
# plt.scatter(s8_minright15_east  ,s8_minright15_north    ,color='blue')
plt.scatter(s8_maxright_east    ,s8_maxright_north      ,color='red')



plt.title('Curve4(RAW)')
plt.legend()
plt.show() 
