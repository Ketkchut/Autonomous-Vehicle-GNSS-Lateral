...
# plt.scatter(661382.42    ,1509560.13      ,color='green'    ,label='Max left')
# plt.scatter(661379.254        ,1509560.13           ,color='green'  ,label='reference')
# plt.scatter(661376.99    ,1509560.13      ,color='green'    ,label='Max right')
...
plt.scatter(s6_maxleft_east     ,s6_maxleft_north       ,color='red'    ,label='Max left')
plt.scatter(s6_ref_east         ,s6_ref_north           ,color='black'  ,label='reference')
plt.scatter(s6_maxright_east    ,s6_maxright_north      ,color='red'    ,label='Max right')
...
plt.scatter(s7_maxleft_east     ,s7_maxleft_north       ,color='red'    ,label='Max left')
plt.scatter(s7_ref_east         ,s7_ref_north           ,color='black'  ,label='reference')
plt.scatter(s7_maxright_east    ,s7_maxright_north      ,color='red'    ,label='Max right')

#...................................................................Set8.........................................................................#
set = 8
df_mxl_1 = pd.read_csv("Curve%d/Set%d/C%d_S%d_MAXLEFT_1.csv" %(curve,set,curve,set))
df_mxl_2 = pd.read_csv("Curve%d/Set%d/C%d_S%d_MAXLEFT_2.csv" %(curve,set,curve,set))
s8_maxleft_east = ( mean(df_mxl_1['x_east']) + mean(df_mxl_2['x_east']) ) /2
s8_maxleft_north = ( mean(df_mxl_1['y_north']) + mean(df_mxl_2['y_north']) ) /2


df_ref_1 = pd.read_csv("Curve%d/Set%d/C%d_S%d_REF_1.csv" %(curve,set,curve,set))
df_ref_2 = pd.read_csv("Curve%d/Set%d/C%d_S%d_REF_2.csv" %(curve,set,curve,set))
s8_ref_east = ( mean(df_ref_1['x_east']) + mean(df_ref_2['x_east']) ) /2
s8_ref_north = ( mean(df_ref_1['y_north']) + mean(df_ref_2['y_north']) ) /2

df_mxr_1 = pd.read_csv("Curve%d/Set%d/C%d_S%d_MAXRIGHT_1.csv" %(curve,set,curve,set))
df_mxr_2 = pd.read_csv("Curve%d/Set%d/C%d_S%d_MAXRIGHT_2.csv" %(curve,set,curve,set))
s8_maxright_east = ( mean(df_mxr_1['x_east']) + mean(df_mxr_2['x_east']) ) /2
s8_maxright_north = ( mean(df_mxr_1['y_north']) + mean(df_mxr_2['y_north']) ) /2

plt.scatter(s8_maxleft_east     ,s8_maxleft_north       ,color='red'    ,label='Max left')
plt.scatter(s8_ref_east         ,s8_ref_north           ,color='black'  ,label='reference')
plt.scatter(s8_maxright_east    ,s8_maxright_north      ,color='red'    ,label='Max right')

#...................................................................Set9.........................................................................#
set = 9
df_mxl_1 = pd.read_csv("Curve%d/Set%d/C%d_S%d_MAXLEFT_1.csv" %(curve,set,curve,set))
df_mxl_2 = pd.read_csv("Curve%d/Set%d/C%d_S%d_MAXLEFT_2.csv" %(curve,set,curve,set))
s9_maxleft_east = ( mean(df_mxl_1['x_east']) + mean(df_mxl_2['x_east']) ) /2
s9_maxleft_north = ( mean(df_mxl_1['y_north']) + mean(df_mxl_2['y_north']) ) /2


df_ref_1 = pd.read_csv("Curve%d/Set%d/C%d_S%d_REF_1.csv" %(curve,set,curve,set))
df_ref_2 = pd.read_csv("Curve%d/Set%d/C%d_S%d_REF_2.csv" %(curve,set,curve,set))
s9_ref_east = ( mean(df_ref_1['x_east']) + mean(df_ref_2['x_east']) ) /2
s9_ref_north = ( mean(df_ref_1['y_north']) + mean(df_ref_2['y_north']) ) /2

df_mxr_1 = pd.read_csv("Curve%d/Set%d/C%d_S%d_MAXRIGHT_1.csv" %(curve,set,curve,set))
df_mxr_2 = pd.read_csv("Curve%d/Set%d/C%d_S%d_MAXRIGHT_2.csv" %(curve,set,curve,set))
s9_maxright_east = ( mean(df_mxr_1['x_east']) + mean(df_mxr_2['x_east']) ) /2
s9_maxright_north = ( mean(df_mxr_1['y_north']) + mean(df_mxr_2['y_north']) ) /2

plt.scatter(s9_maxleft_east     ,s6_maxleft_north-3       ,color='red'    ,label='Max left')
plt.scatter(s9_ref_east         ,s6_ref_north-3           ,color='black'  ,label='reference')
plt.scatter(s9_maxright_east    ,s6_maxright_north-3      ,color='red'    ,label='Max right')

plt.scatter(661466.0666063947 ,1509511.7028251023      ,color='green'    ,label='Max left')
plt.scatter(661466.0747819836 ,1509509.8209059625           ,color='green'  ,label='reference')
plt.scatter(661466.1063385024 ,1509507.7851435295      ,color='green'    ,label='Max right')

plt.title('Curve3(RAW)')
# plt.legend()
plt.show() 
